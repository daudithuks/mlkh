...
class Consultant extends Secure_area {
	...
	function _reload($data=array())
	{
		...
		$data['lab_queue'] = $this->Consultation->get_lab_queue($person_info->person_id);
		$data['xray_queue'] = $this->Consultation->get_xray_queue($person_info->person_id);
		...
		if($this->Consultation->referred($customer_id,$consultant_id)) { $data['referred'] =$this->Consultation->referred($customer_id,$consultant_id); }
	...
	{
		$doctor = trim($this->input->post('refer_doctor'));
		$department = trim($this->input->post('refer_department'));
		$description = trim($this->input->post('refer_description'));
